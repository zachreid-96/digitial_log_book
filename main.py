...
class Log_Book_GUI:
    def __init__(self, gui_root):
        ...
        self.menu.add_command(label="Process Logs", command=self.process_menu_load)
        self.menu.add_command(label="Database", command=self.database_menu_load)
        self.menu.add_command(label="Settings", command=self.settings_menu_load)
        self.menu.add_command(label="Help", command=self.help_menu_load)
        """
